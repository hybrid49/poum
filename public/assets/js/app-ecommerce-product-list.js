...
$(function () {
  ...
  var dt_product_table = $('.datatables-products'),
    ...
    statusObj = {
      1: { title: 'Commandé', class: 'bg-label-warning' },
      2: { title: 'En stock', class: 'bg-label-success' },
      3: { title: 'Retiré', class: 'bg-label-danger' },
      4: { title: 'Vide', class: 'bg-label-primary' }
    },
    categoryObj = {
      0: { title: 'Biere' },
      1: { title: 'Vin' },
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            var categoryBadgeObj = {
              ...
              Autre: '<span class="avatar-sm rounded-circle d-flex justify-content-center align-items-center bg-label-primary me-2"><i class="ti ti-device-gamepad-2 ti-xs"></i></span>'
            };
            return (
